...
onMounted(async () => {
  sidebar.setPageName('View Expense')
...
function goToEdit() {
  router.push({ name: 'edit_payment', params: { id: transactionId } })
}
...
<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h2 class="text-3xl font-bold tracking-tight">Expense Transaction</h2>
        <p class="text-muted-foreground">View expense transaction details</p>
      </div>
        ...
        <CardHeader>
          <div class="flex items-start justify-between">
            <div>
              ...
              <CardDescription>Expense Transaction</CardDescription>
            </div>
        ...
        <CardContent>
          <dl class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <dd class="mt-1 text-2xl font-bold text-destructive">{{ formatAmount(transaction.amount) }}</dd>
            </div>
            <div>
            ...
            <div>
              <dt class="text-sm font-medium text-muted-foreground">Pay To</dt>
              <dd class="mt-1 text-base">{{ toName }}</dd>
            </div>
            <div>
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell class="text-right font-bold text-destructive">{{ formatAmount(transaction.amount) }}</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </CardContent>
